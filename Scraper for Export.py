...
headers = {'User-Agent': "xy@gmail.com"}
#Replace XY@gmail with your email. I'm not trying to steal your email its just so the SEC API responds properly. You can
#try your luck and not have a valid email. It might still work
desired_tickers = ['AAPL', 'MSFT', 'AMZN']
#Put in your list of tickers with each one surrounded by '' and separated by a ,
...
#fact_storage['0000320193']['facts']['us-gaap']
#just for people who want to identify more 'facts'
