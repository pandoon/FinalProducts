...
calculate_ratios(r"YOUR PATH HERE", 'TICKER,CIK')
#Step 1: Run cells all the cells below.
#Step 2: Right click on the output of the Scraper. Click: Copy Path. Paste it in YOUR PATH HERE.
#Step 3: Open the output excel from the Scraper. Currently the system checks only 1 sheet at a time. Copy paste the sheet name
#into where 'TICKER,CIK' is.
...
# Example usage
#result_df = calculate_ratios(r"PATH", 'TICKER,CIK')
#print(result_df)
